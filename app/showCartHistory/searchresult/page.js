...
const InvoiceTable = () => {
    const data = [
        {
            no: 1,
            orderNo: 'LD/IS/NY/2025/4',
            date: '2/17/2025 5:58',
            memoTerms: 'Cash',
            noOfDays: 2,
            createdBy: 'krigel',
            customerName: 'KRIGEL MESH DIAMONDS',
            pcs: 1,
            cts: 11.23,
            invoiceTotal: 7810.47,
            totalAmtS: 7810.47,
            invReport: '',
            memoReport: '',
            saleInv: ''
    ...
    const totals = {
        ...
        invoiceTotal: data.reduce((sum, row) => sum + row.invoiceTotal, 0),
        totalAmtS: data.reduce((sum, row) => sum + row.totalAmtS, 0),
    };
