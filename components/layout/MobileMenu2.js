            ...
            <div className="mobile-nav__wrapper">
                ...
                <div className="mobile-nav__content">
                    ...
                    <div className="logo-box">
                        <Link href="/serch" aria-label="logo image"><img src="/assets/images/resources/logo-1.png" width="150" alt="" style={{ filter: "invert(1)" }} /></Link>
                    </div>

                    <div className="mobile-nav__container">
                        <div className="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                            <ul className="main-menu__list">
                                <li className={isActive.key == 1 ? "dropdown current" : "dropdown"}><Link href="/serch">Home</Link>
                                ...
                                <li className={isActive.key == 2 ? "dropdown current" : "dropdown"}><Link href='#'>Stone Inventory</Link>
                                    <ul style={{ display: `${isActive.key == 2 ? "block" : "none"}` }}>
                                        <li>
                                            <Link href="/serch">Stone Inventory</Link>
                                        </li>
                                        <li>
